...
Since my current workplace (Susquehanna) has a strict proxy, I'll be using straight.el in order to vendor the packages I use within this repo,
ensuring that I can use emacs, anywhere >:)

#+begin_src emacs-lisp
  ;; Disable package.el's automatic handling; we'll use straight.el instead.
  ...
  ;; Install use-package itself via straight
  (straight-use-package 'use-package)
  (require 'use-package)

  ;; straight.el takes care of installs, so no need for :ensure
